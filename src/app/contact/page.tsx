...
const Contact = () => {
  return ( 
    <div id="Contact"  className=" bg-gray-200 dark:bg-gradient-to-br from-gray-800 via-gray-700 to-gray-800">
      <section className="text-gray-600  body-font relative ">
        <div className="container px-5 py-24 mx-auto flex sm:flex-nowrap flex-wrap">
          ...
          <div className="lg:w-1/3 p-4 rounded-2xl md:w-1/2 bg-white flex flex-col md:ml-auto w-full md:py-8 mt-8 md:mt-0 dark:text-gray-100 dark:bg-gradient-to-br from-gray-900 via-gray-600 to-gray-900 bg-gray-300">
            <h2 className="title-font sm:text-4xl text-3xl dark:text-gray-200 mb-4 font-medium text-gray-900 text-center">
              Contact
            </h2>
            <p className="leading-relaxed mb-5 dark:text-gray-200 text-gray-600 text-center">

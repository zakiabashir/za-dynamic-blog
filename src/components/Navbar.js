...
const Navbar = () => {
  ...
  return (
    <nav className="p-4 bg-gray-200 dark:bg-gray-800 text-red-900 dark:text-white sticky top-0 backdrop-blur border-b z-10">
      <LoadingBar color="#433ce6" progress={progress} onLoaderFinished={() => setProgress(0)} />
      <div className="container mx-auto flex justify-between items-center">
        <Link href={"/"}>
          <div className="text-lg font-bold">ZakiaBlog</div>
        </Link>
